...
| **최근에 뭘 했나** | `docs/작업기록_2026-08-29_Claude_SS2D_흑백대칭_흰색키트.md` ★ 색 시스템 흑백 대칭 · **흰색 키트 6종** · 짝 없으면 반전 대체 |
...
| **맵을 찍는다 (지형)** | `scenes/집/스마트 매쉬 assets/README_지형찍기.md` ★ Template 복제해서 점만 편집 |

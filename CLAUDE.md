...
- 엔진: **Godot 4.6-beta2** · 브랜치 **dev_4** · 지형은 SmartShape2D(SS2D).
- 게임 켜기: F5 → 로비 → **시작** (= 스마트월드 1편)
- 스테이지 4개가 **통로로** 이어진다 (포탈 없음): `스마트월드_1 → 2 → 3 → 4`
...
| 최근에 뭘 했나 | `docs/작업기록_2026-08-17_도형_카메라공간_굴뚝심리스_지형뿌리내리기.md` |

...
func _도형표() -> Array:
	return [
		["직선", _사각(1300, 230), 1300.0],
		["사각형", _사각(560, 560), 560.0],
		["L자", _L자(700, 700, 260), 700.0],
		["오목", _ㄷ자(700, 700, 250), 700.0],
		["볼록", _사각(430, 430), 430.0],
		["작은곡선", _원(150, 16), 300.0],
		["큰곡선", _언덕(420, 170, 24), 840.0],
		["둥근형태", _원(280, 24), 560.0],
		["복합폐곡선", _복합(640), 640.0],
	]
...
func _실행() -> void:
	...
	cam.name = "카메라"
	cam.position = Vector2(블록폭 * 0.45, y * 0.5)
